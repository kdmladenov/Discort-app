...
export function PlusIcon({ className = 'h-5 w-5 text-gray-500' }: IconProps): JSX.Element {
  return (
    <svg
...
export function ChevronRight({ className = 'h-5 w-5 text-gray-500' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function ChevronDown({ className = 'h-5 w-5 text-gray-500' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function SpeakerMuted({ className = 'h-5 w-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function Speaker({ className = 'w-full h-full' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function Present({ className = 'w-full h-full' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ArrowUturnLeft({ className = 'w-5 h-5' }: IconProps): JSX.Element {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
